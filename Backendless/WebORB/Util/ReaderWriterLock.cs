...
namespace Weborb.Util
{
    ...
    public sealed class ReaderWriterLock
    {
        ...
        internal class ReadLockable : ILockable
        {
            ...
            internal ReadLockable(ReaderWriterLock lockObj)
            {
                _lockObj = lockObj;
            }
        }
        ...
        internal class WriteLockable : ILockable
        {
            ...
            internal WriteLockable(ReaderWriterLock lockObj)
            {
                _lockObj = lockObj;
            }
        }
        ...
        internal class ReaderLock : IDisposable
        {
            ...
            internal ReaderLock(ReaderWriterLock lockObj)
            {
                _lockObj = lockObj;
        ...
        internal class WriterLock : IDisposable
        {
            ...
            internal WriterLock(ReaderWriterLock lockObj)
            {
                _lockObj = lockObj;
