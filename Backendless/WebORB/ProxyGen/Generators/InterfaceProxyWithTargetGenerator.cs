...
namespace Weborb.ProxyGen.DynamicProxy.Generators
{
	...
	public class InterfaceProxyWithTargetGenerator : BaseProxyGenerator
	{
        ...
        protected IDictionary<MethodInfo, NestedClassEmitter> method2Invocation = new Dictionary<MethodInfo, NestedClassEmitter>();
		protected IDictionary<MethodInfo, MethodInfo> method2methodOnTarget = new Dictionary<MethodInfo, MethodInfo>();
