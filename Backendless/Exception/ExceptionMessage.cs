namespace BackendlessAPI.Exception
{
    public class ExceptionMessage
    {
        ...
        public static string NULL_GEO_QUERY = "Geo query should not be null";
        public static string INCONSISTENT_GEO_RELATIVE = "Geo query should contain relative metadata and a threshold for a relative search";
    }
}