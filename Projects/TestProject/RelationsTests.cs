...
namespace TestProject
{
  ...
  public class RelationsTests
  {
    ...
    {
      TestInitialization.DeleteTable( "Orders" );
      TestInitialization.DeleteTable( "Area" );
      TestInitialization.DeleteTable( "CountryLanguage" );
      TestInitialization.DeleteTable( "Country" );
      TestInitialization.DeleteTable( "Capital" );
    }
