  ...
  public class MainApplication : Application, Application.IActivityLifecycleCallbacks
  {
    ...
    void RegisterDependencies()
    {
      ...
      if( Settings.IsUsingLocalDataSource )
        ...
        builder.RegisterInstance( _LazyBackendlessSource.Value ).As<IDataSource<Acquaintance>>();
    ...
    static Lazy<BackendlessDataSource> _LazyBackendlessSource = new Lazy<BackendlessDataSource>( () => new BackendlessDataSource() );
