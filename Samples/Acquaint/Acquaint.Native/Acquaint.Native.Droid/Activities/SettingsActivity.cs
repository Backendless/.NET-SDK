...
namespace Acquaint.Native.Droid
{
  ...
  public class SettingsActivity : AppCompatActivity
  {
    ...
    void SetupViews()
    {
      ...
      _BackendUrlField = contentLayout.InflateAndBindEditText( Resource.Id.settingsBackendUrlField, Settings.BackendlessServiceUrl );
    ...
    void Save()
    {
      ...
      Task.Factory.StartNew( async () =>
      {
        ...
        else
        {
          ...
          if( Settings.BackendlessServiceUrl.ToLower() != _BackendUrlField.Text.ToLower() )
            localStoreResetConditions++;

          // set the backend service URL
          Settings.BackendlessServiceUrl = _BackendUrlField.Text;
