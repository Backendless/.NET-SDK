...
namespace Acquaint.Native.Droid
{
  ...
  public class AcquaintanceListActivity : AppCompatActivity
  {
    ...
    async Task LoadAcquaintances()
    {
      ...
      catch( Exception ex )
      {
        ...
        alert.SetMessage( "Ensure you have a network connection, and that you entered valid Backendless Application ID and .NET API Key in the Acquaint.Util.NetStandard project (see the Settings class)." );
  ...
  internal class AcquaintanceCollectionAdapter : RecyclerView.Adapter, View.IOnClickListener
  {
    ...
    public void OnClick( View view )
    {
      ...
      detailIntent.PutExtra( view.Context.Resources.GetString( Resource.String.acquaintanceDetailIntentKey ), acquaintance.ObjectId );
