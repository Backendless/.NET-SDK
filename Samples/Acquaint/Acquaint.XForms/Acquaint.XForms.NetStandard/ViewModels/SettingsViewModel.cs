...
namespace Acquaint.XForms
{
  ...
  {
    public string BackendlessServiceUrl { get; set; }
    ...
    public SettingsViewModel()
    {
      ...
      BackendlessServiceUrl = Settings.BackendlessServiceUrl;
    ...
    async Task ExecuteSaveCommand()
    {
      ...
      else
      {
        ...
        Uri testUri;
        if( !Uri.TryCreate( BackendlessServiceUrl, UriKind.Absolute, out testUri ) )
        {
        ...
        if( Settings.BackendlessServiceUrl.ToLower() != BackendlessServiceUrl.ToLower() )
          localStoreResetConditions++;

        // set the backend service URL
        Settings.BackendlessServiceUrl = BackendlessServiceUrl;
