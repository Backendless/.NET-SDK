...
namespace Acquaint.XForms
{
  public class AcquaintanceListViewModel : BaseNavigationViewModel
  {
    ...
    void SetDataSource()
    {
      _DataSource = SimpleIoc.Default.GetInstance<IDataSource<Acquaintance>>();// ServiceLocator.Current.GetInstance<IDataSource<Acquaintance>>();
    }
    ...
    void ExecuteDialNumberCommand( string acquaintanceId )
    {
      ...
      var acquaintance = _Acquaintances.SingleOrDefault( c => c.ObjectId == acquaintanceId );
