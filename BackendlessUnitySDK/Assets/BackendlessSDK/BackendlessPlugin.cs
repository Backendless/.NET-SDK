...
#if UNITY_EDITOR // This is so we can debug Console.WriteLine log output from .NET code in Backendless.dll
		//Debug.LogError("Redirecting system console to Unity's console");
