...
import jp.funx.backendlessunitysdk.ExtendedUnityPlayerActivity;
...
public final class GCMRegistrar
{
  ...
  public static void checkDevice( Context context )
  {
    ...
    if( version < 8 ) {
      ...
      //                                                 "API Level 8 (instead of " + version + ")" );
    	...
    	Log.e("GCMRegistrar", "GCMRegistrar#checkDevice: Push Registration error: "
  ...
  {
    return context.getSharedPreferences( PREFERENCES + ExtendedUnityPlayerActivity.UNITY_PREFS_FILE_SUFFIX, Context.MODE_PRIVATE );
  }
